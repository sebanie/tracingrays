...
Scene::Scene(){
  ...
  shapes->push_back(new Triangle(pt0, pt2, pt3, red, blue, black, 1.0));
  shapes->push_back(new Triangle(pt0, pt1, pt2, red, green, black, 1.0));
  shapes->push_back(new Sphere(sphereCent, 1.0, red, black, black, 1.0));
  outputFile = "out.png";
